...
from api.database.normalize_municipio import construir_indices, normalizar, resolver_municipio_id
from api.models import AutoLinha, Permissionaria, TrechoAutoLinha, TipoServico
