...
from api.models import AutoLinha, Municipio, Permissionaria, TipoServico, TrechoAutoLinha
from api.repositories.types import AutoDict, MunicipioDict, PermissionariaDict
